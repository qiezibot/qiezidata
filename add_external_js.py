...
#  插入在最后一个路由之后
last_def = c.rfind('async def ')
next_end = c.find('\n', last_def)
after_last_def = c[last_def:]
...
if name_pos < 0:
    name_pos = c.find("if __name__")
routes += '\n\n\n\n'
c = c[:name_pos] + routes + c[name_pos:]
