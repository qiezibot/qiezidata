# -
<a class="nav-item" href="#" onclick="switchPage('apidocs',this)"><span class="nav-icon" style="font-size:18px">📖</span><span class="nav-text">API文档</span></a>*- coding: utf-8 -*-
"""
Fil
...
<div style="margin-bottom:8px;font-size:16px;font-weight:bold">上传文本文件</div>
<div>
<span style="font-size:14px">Key:</span>
<input id="cdUploadKey" type="text" style="width:200px;padding:4px;border-radius:4px;border:1px solid #ccc" placeholder="输入key标识符">
