...
<div class="nav-bottom"><a onclick="openProfile()" style="cursor:pointer">&#x1f464; <!--U--></a> &middot; <a href="/logout">退出登录</a></div>
...
<div class="header"><span class="title">管理后台</span><span class="user-area"><a onclick="openProfile()" style="cursor:pointer;color:inherit;text-decoration:none">&#x1f464; <!--U--></a></span></div>
...
<div class="card"><h2>用户列表</h2><table class="user-table"><thead><tr><th>ID</th><th>用户名</th><th>显示名称</th><th>角色</th><th>创建时间</th><th>操作</th><th>修改密码</th></tr></thead><tbody id="userTableBody"></tbody></table></div>
