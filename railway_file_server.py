...
<div class="card"><h2>用户列表</h2><table class="user-table"><thead><tr><th>ID</th><th>用户名</th><th>显示名称</th><th>角色</th><th>创建时间</th><th>操作</th><th>密码</th><th>密码</th></tr></thead><tbody id="userTableBody"></tbody></table></div>
