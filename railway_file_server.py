...
var _cu=0;
function adminChangePwd(u){_cu=u;document.getElementById("changePasswordModal").style.display="flex";document.getElementById("cpUserInfo").textContent="\u7528\u6237ID: "+u;document.getElementById("cpNewPwd").value="";document.getElementById("cpMsg").style.display="none"}
